...
$.extend( $.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format( "No se aceptan mas caracteres de {0}." ),
		minlength: $.validator.format( "No se aceptan menos longitud de caracteres que {0}." ),
		...
		step: $.validator.format( "Por favor introduzca un valor multiplo de {0}" )
	},
